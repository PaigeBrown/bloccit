...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "PUT update" do
    it "updates questions with expected attributes" do
      ...
      put :update, id: my_question.id, question: { title: new_title, body: new_body, resolve: false}
    ...
    it "redirects to the updated question" do
       new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
      put :update, id: my_question.id, question: { title: new_title, body: new_body, resolve: true}
